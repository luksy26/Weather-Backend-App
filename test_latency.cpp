...
int main(int argc, char *argv[]) {
	...
	std::cout << total_subscribe_time << ";"
			  << total_subscribe_time / num_clients << ";" << total_notify_time
			  << ";" << total_notify_time / num_updates << ";"
			  << total_request_time << ";" << total_request_time / num_clients
			  << ";";
